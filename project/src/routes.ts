...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/exchange/shop', component: () => import('./components/pages/user/Exchange/MaterialsShop.vue'), meta: { requiresAuth: true } },
  ...
  ...['/games/duel/:rest(.*)*', '/games/five/:rest(.*)*', '/chat/:rest(.*)*', '/city', '/top', '/statistic'].map(path => ({ path, component: unavailable })),
