...
const state: CraftState = {
  ...
  categories: [{id: 1, name: 'Дерево', code: 'wood', description: 'Обработка дерева'}], stations: [], skills: [], inventory: [{item_id: 1, quantity: 4}], credit: 0, charge_credits: false, starter_available: false, gather_available: true, slot_limit: 200, slots_used: 1,
};
