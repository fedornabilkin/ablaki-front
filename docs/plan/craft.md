...
> Актуализация 20.09.2026: исторические отметки ниже относятся к демо, не к серверной экономике. Backend-модуль craft уже существует, но требует завершения API и операций. Активный план: [классический крафт](../../plans/2026-09-20-classic-crafting.md). user/persone.credit — единственный аккаунт/баланс. Таймер и биржа отложены. Переключение одной env-переменной не является интеграцией.
